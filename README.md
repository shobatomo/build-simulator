...
React/Vite + Express MVP for a Deadlock MOBA build simulator. The current app uses mock data while keeping the model close to a future Supabase-backed implementation.
